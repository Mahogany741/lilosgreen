    ...
    <div class="main-wrapper">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="Api-CNPJ.php">Cadastro de Parceiro</a></li>
        ...
        <div class="checkout-page section-padding-0">
            ...
            <div class="container d-flex justify-content-center">
                ...
                <form action="processa_form_API_CNPJ.php" method="GET">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="checkout-form mt-30">
                                ...
                                <div class="checkout-title">
                                    ...
                                    <h4 class="title">Insira seu CNPJ abaixo:</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="cart-form-btn">
                                            ...
                                            <button style="line-height: 38px; margin-top:10px; border-radius: 3px; height: 40px; width: 100%;" class="btn btn-primary">Avançar</button>
